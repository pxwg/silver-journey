...
return {
  s({
    ...
    wordTrig = true,
    trigEngine = "pattern",
  }, t("\\mathrm{d} "), { condition = tex.in_latex }),
  ...
  s({
    ...
    wordTrig = true,
    trigEngine = "pattern",
  }, t("\\mathcal{D} "), { condition = tex.in_latex }),
  ...
  s({
    ...
    wordTrig = true,
    trigEngine = "pattern",
  }, d(1, full_derivative, {}, { user_args = { [[\mathrm{d}]] } }), { condition = tex.in_latex }),
  s({
    trig = "part",
    snippetType = "autosnippet",
    wordTrig = true,
    trigEngine = "pattern",
  }, d(1, full_derivative, {}, { user_args = { [[\partial]] } }), { condition = tex.in_latex }),
  s({
    trig = "vara",
    snippetType = "autosnippet",
    wordTrig = true,
    trigEngine = "pattern",
  }, d(1, full_derivative, {}, { user_args = { [[\delta]] } }), { condition = tex.in_latex }),
